<div>
    ...
    <nav class="level my-6">
        ...
        <div class="level-left">
            ...
            <div class="level-item has-text-centered">
                    <a wire:click='addPermission' class="button is-dark">
        ...
        <tbody>
            ...
            <tr wire:key="{{ $record->id }}">
                ...
                <td class="has-text-right">
                    ...
                    <a wire:click="viewPermission({{ $record->id}})">
                        <span class="icon"><x-carbon-view/></span>
                    </a>

                    @role(['admin'])
                        <a wire:click="editPermission({{ $record->id }})">
    ...
    {{ $permissions->links('components.pagination.bulma') }}
