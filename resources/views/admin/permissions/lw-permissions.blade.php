<section class="section container">
    ...
    <script>
        ...
        window.addEventListener('ConfirmDelete',function(e) {
            ...
            let sa_title = 'Do you really want to delete this Permission?'
    ...
    @switch($action)
        ...
        @case('FORM')
            @include('admin.permissions.lw-permissions-form')
            @break

        @case('VIEW')
            @include('admin.permissions.lw-permissions-view')
            @break

        @case('LIST')
        @default
            @include('admin.permissions.lw-permissions-list')
            @break
