...
<footer class="footer has-background-dark ">
    ...
    <div class="columns">
        ...
        <div class="column is-4 has-text-centered-mobile">
            ...
            <a href="{{config('appconstants.kapkara.link')}}" class="has-text-weight-light has-text-info-light">{{config('appconstants.kapkara.name')}}</a>
        ...
        <div class="column is-4 has-text-centered my-6 is-2">
            <p class="has-text-weight-light is-hidden-mobile has-text-info-light">{{config('appconstants.app.name')}}</p>
            <span class="icon is-large has-text-info"><x-carbon-model-alt /></span>
        </div>

        <div class="column is-4 has-text-info-light">
