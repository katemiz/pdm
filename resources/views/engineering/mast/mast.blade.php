    ...
    @if ($action == 'deflection' || $action == 'mttubes')
        ...
        <div class="modal {{ $showModal ? 'is-active' :'' }}" id="modal">
            ...
            <div class="modal-content box">
                <h1 class="title">MT-{{ !empty($singleTubeData) ? sprintf("%02d",$singleTubeData["no"]) : '' }} Tube Details</h1>
                <table class="table is-fullwidth">
                    ...
                    <tr>
                        ...
                        <td class="has-text-right">{{ !empty($singleTubeData) ? Number::format($singleTubeData["areaBasic"],locale:'de',precision:0) : '' }} mm<sup>2</sup></td>
                    </tr>
                    ...
                    <tr>
                        <th>Area Increase (%)</th>
                        <td class="has-text-right">{{ !empty($singleTubeData) ? Number::format(($singleTubeData["area"]-$singleTubeData["areaBasic"])/$singleTubeData["areaBasic"]*100,locale:'de',precision:0) : '' }} %</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="has-text-right">{{ !empty($singleTubeData) ? Number::format($singleTubeData["inertiaBasic"],locale:'de',precision:0) : '' }} mm<sup>4</sup></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="has-text-right">{{ !empty($singleTubeData) ? Number::format(($singleTubeData["inertia"]-$singleTubeData["inertiaBasic"])/$singleTubeData["inertiaBasic"]*100,locale:'de',precision:0) : '' }} %</td>
                    </tr>
